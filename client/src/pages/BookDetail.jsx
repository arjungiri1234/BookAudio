    ...
    <div className="page-container fade-in">
      ...
      <div className="flex items-start justify-between gap-4 mb-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold font-display text-surface-800">{currentBook?.title}</h1>
            {currentBook?.author && currentBook.author.trim() && (
              <p className="text-surface-500 mt-1">by {currentBook.author}</p>
            )}
